...
RESTfull сервіс для керування таблицею 'user' бази даних 'quiz' було розроблено мовою Python з використанням фреймворку Flask. Цей сервіс є базовим CRUD застосунком, та забезпечує функції читання, створення, редагування та видалення даних.
